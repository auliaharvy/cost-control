...
RIGHT JOIN mst_project as a ON b.project_id = a.id");
	...
	public function getBiayaRap($id,$kategori_id){
		$this->db->select('
          ...
          IF(a.jumlah_aktual is NULL,0,ROUND(((jumlah_aktual) / (jumlah_biaya) * 100),2)) as presentase
      ');
	...
	public function showpengajuandetail($id){
		$this->db->select('
          a.*,b.nama_jenis_rap,b.nama_pekerjaan,c.note_app,c.jumlah_approval,c.is_send_cash,FORMAT(c.jumlah_approval,0,"de_DE") as jumlah_approval_v,FORMAT(a.jumlah_pengajuan,0,"de_DE") as jumlah_pengajuan_v
      ');
	...
	public function dataPencairan($id){
		...
		public function dataPembelian($id){ //pembelian berdasarkan pengajuan
		...
		public function dataPembelianRemaining($id){ //pembelian berdasarkan pengajuan
