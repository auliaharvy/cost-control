                        ...
                        <tr class="odd gradeX">
                          ...
                          <?php if (($this->session->userdata('role')) == 4) { ?>
                            <td style="width: 10%; vertical-align:middle;" align="center">
                              <?php if ($d['is_pay'] == 0) { ?>
                                <a href="<?php echo site_url('bayarhutang/' . $d['id']); ?>" onclick="return confirm('Apakah Anda Ingin Membayar Hutang <?= $d['project_name']; ?> ?');" class="btn btn-success btn-circle btn-sm" data-popup="tooltip" data-placement="top" title="Bayar Hutang"><i class="fa fa-edit"></i></a>
                                <form action="<?php echo site_url('hapushutang'); ?>" method="post">
                                  <input type="hidden" name="id_hutang" value="<?php echo $d['id']; ?>">
                                  <button style="border-radius: 5px;" type="submit" onclick="return confirm('Apakah Anda Ingin Menghapus Data Hutang di <?= $d['project_name']; ?> ?');" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></button>
                                </form>
                            </td>
                        <?php }
                            } ?>
