...
{
                                         $nomor = 1;
                                         foreach($data_pembelian as $d){  $idx=$d['id'];?>
                                        <tr class="odd gradeX">
                                           ...
                                           <td>Rp <?php echo $d['jumlah_uang_pembelian_v']; ?></td>
                                            <td align="center">
                                             ...
                                             <?php } else { ?>  
                                                <a data-toggle="modal" style="width: 120px;" data-target="" class="btn btn-danger btn-circle disabled" data-popup="tooltip" data-placement="top" title="Edit Data">TELAH DIBELANJAKAN</a>
                                             <?php } ?>
