...
class M_pembelian extends CI_Model {
	...
	public function showPencairan($id,$destination_id){
		$this->db->select('
	...
	public function showBiayaRemainingOffice($id,$destination_id,$user_id){ //data untuk mengurangi pembelian yang remaining
		$this->db->select('
