...
class M_data extends CI_Model {
	...
	public function GetKasRange($range){ //master kas di dashboard
	...
	public function GetKas(){ //master kas di dashboard
	...
	public function GetPie(){
	      ...
	      $data = $this->db->query("SELECT organization_name as kas_name,cash_in_hand FROM mst_organization UNION
SELECT kas_nam AS kas_name,cash_in_hand FROM 
(SELECT CONCAT(b.nama_type,' ',c.fullname) AS kas_nam, cash_in_hand FROM mst_office AS a
JOIN mst_office_type AS b ON a.type_office_id=b.id
JOIN mst_users AS c ON a.user_id=c.id) AS office
WHERE office.cash_in_hand > 0 UNION
SELECT project_name as kas_name,cash_in_hand FROM mst_project WHERE cash_In_hand > 0");
...
SELECT organization_name as kas_name,cash_in_hand FROM mst_organization UNION
SELECT kas_nam AS kas_name,cash_in_hand FROM 
(SELECT CONCAT(b.nama_type,' ',c.fullname) AS kas_nam, cash_in_hand FROM mst_office AS a
JOIN mst_office_type AS b ON a.type_office_id=b.id
JOIN mst_users AS c ON a.user_id=c.id) AS office
