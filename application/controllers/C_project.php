...
class C_project extends CI_Controller {
	...
	public function index() //project on progress
	{
       ...
       // $data = $this->M_data->showproject("mst_project",$status);
    ...
    public function detail_pengajuan($id){ //belom diapaapain
    ...
    public function finishing_project(){ //menyelesain project
        $id = $_POST['id_project'];
